...
const SellerSchema = new mongoose_1.Schema({
    ...
    businessType: {
        type: String,
        required: true,
        enum: Object.values(enums_1.EBusinessType),
        default: enums_1.EBusinessType.RETAIL,
    },
    otp: { type: String },
    loggedIn: {
        type: String,
        enum: Object.values(enums_1.ELoginStatus),
        default: enums_1.ELoginStatus.LOGGED_OUT,
    },
    role: { type: String, default: enums_1.ERole.SELLER },
});
